...
#create nsr dataset
nsr_filename = os.path.join(ds_path,"nsr_C.mat")
h5nsr = h5py.File(nsr_filename, "r+")

if False:
    dset_nsr = h5nsr.create_dataset("nsr", (nblocks,nsim), dtype='f')
else:
    dset_nsr = h5nsr["nsr"]
...
#geomet datasets
h5geomet = h5py.File(os.path.join(home,"results","geomet_C.mat"),"r")
